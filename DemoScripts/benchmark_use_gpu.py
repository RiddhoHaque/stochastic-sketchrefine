...
and LP-first, comparing use_gpu=True vs use_gpu=False.
...
CONFIGS = [
    ('LP_First / use_gpu=True',
     {'solve_lp_first': True, 'use_gpu': True}),
    ('LP_First / use_gpu=False',
     {'solve_lp_first': True, 'use_gpu': False}),
]
...
def main():
    ...
    out_path = os.path.join(eval_dir, 'benchmark_use_gpu.txt')
